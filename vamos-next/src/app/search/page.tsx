...
import { Search, MapPin, Calendar, Users, Star, Clock, ChevronRight, Navigation } from "lucide-react";
...
export default function SearchPage() {
  ...
  // Mock initial rides if none found or for demo
  const mockRides = [
    {
      id: "mock1",
              ...
              <div className="flex justify-between items-start mb-6">
                <div className="flex items-center gap-3">
                  <div className="relative">
                    <img src={ride.driver?.avatar || "https://i.pravatar.cc/150?u=user"} className="w-12 h-12 rounded-full border-2 border-[#62AAE5]" alt={ride.driver?.name} />
