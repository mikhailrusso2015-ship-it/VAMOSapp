    ...
    <div className="flex flex-col min-h-screen bg-[#040521]">
      ...
      {step === 1 && (
        <main className="flex-1 px-6 space-y-8 animate-in fade-in slide-in-from-right-4 duration-500 pb-24">
          ...
          <button 
            onClick={() => setStep(2)}
            className="w-full bg-[#62AAE5] text-white py-5 rounded-[24px] font-black text-lg shadow-[0_10px_30px_rgba(98,170,229,0.3)] active:scale-95 transition-all flex items-center justify-center gap-3"
          >
            <span>Continuar</span>
            <ArrowRight size={20} />
          </button>
